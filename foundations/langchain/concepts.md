...
- [tools](https://docs.langchain.com/oss/python/langchain/tools) are callable functions with well-defined inputs and outputs that get passed to a chat model. The model decides when to invoke a tool based on the conversation context, and what input arguments to provide. [Create-tools](https://docs.langchain.com/oss/python/langchain/tools#create-tools)
- Memory is a system that remembers information about previous interactions.[Short term memory](https://docs.langchain.com/oss/python/langchain/short-term-memory) lets your application remember previous interactions within a single thread or conversation.
